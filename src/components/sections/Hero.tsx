    ...
    <div className="flex justify-between">
      <div className="w-full">
        ...
        <div className="relative max-w-lg justify-center items-center">
          <div className="absolute top-40 sm:left-44 w-52 sm:w-72 h-52 sm:h-72 bg-sky-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob" />
          <div className="absolute top-52 sm:-right-40 w-52 sm:w-72 h-52 sm:h-72 bg-orange-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000" />
          <div className="absolute top-16 sm:-right-24 w-52 sm:w-72 h-52 sm:h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000" />
        </div>
