  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col justify-start">
        ...
        <h1 className="text-5xl font-bold text-foreground">Questions</h1>
      </div>
      <div className="flex justify-start space-x-16 pt-12">
      ...
      <div className="flex justify-start space-x-16 pt-8">
        <div className="flex flex-col px-8 pt-8">
          <h1 className="text-3xl font-semibold">How does Expanse work?</h1>
          <p className="text-lg text-muted-foreground">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam
